...
Widget** createSimpleStartWindowWidgets(SDL_Renderer* renderer) {
	...
	widgets[0] = createSimpleButton(renderer, &newGameR, "./newGameBtn.bmp",NULL,CH_BTN_NEW_GAME,0,BTN_ACTIVE);
	widgets[1] = createSimpleButton(renderer, &loadR, "./loadBtn.bmp",NULL,CH_BTN_LOAD,0,BTN_ACTIVE);
	widgets[2] = createSimpleButton(renderer, &exitR, "./exitBtn.bmp",NULL,CH_BTN_EXIT,0,BTN_ACTIVE);
